...
(function ($) {
    ...
    // Verifique se o DOM está completamente carregado
    document.addEventListener('DOMContentLoaded', function () {
        
        // Seleciona o botão com a classe .sweet-success-cancel e adiciona o evento de clique
        document.querySelector(".sweet-success-cancel").onclick = function () {
            Swal.fire({
                title: "Are you sure to delete?",
                text: "You will not be able to recover this imaginary file!",
        ...
        // (Coloque aqui o código para os outros botões se necessário)
