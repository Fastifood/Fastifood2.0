<div class="nav-header">
    <a href="index.html" class="brand-logo">
        <img class="logo-abbr" viewBox="0 0 39 31" fill="none" src="images/logo.png" alt="Logo">
        <h1 class="brand-title" xmlns="http://www.w3.org/2000/svg">SpeedFood</h1>
    </a>
                                        ...
                                        <div class="card-header d-block border-0">
                                            ...
                                            <ul class="d-flex align-items-center flex-wrap">
                                                <li><a href="javascript:void(0);"
                                                        class="btn btn-outline-light btn-rounded me-2">Bakery</a></li>
                                                <li><a href="javascript:void(0);"
                                                        class="btn btn-outline-light btn-rounded me-2">Burger</a></li>
                                                <li><a href="javascript:void(0);"
                            ...
                            <div class="dropdown header-profile2 ">
                                <a class="nav-link " href="javascript:void(0);" role="button"
                                    ...
                                    <div class="header-info2 d-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center sidebar-info">
                                            <div>
                                                @if(Auth::check())
                                                    <h6 class="font-w500 mb-0 ms-2">Olá, {{ $nomeDoUsuario }}</h6>
                                                @else
                                                    <h6 class="font-w500 mb-0 ms-2">Convidado</h6>
                                                @endif
                                            </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="./email-inbox.html" class="dropdown-item ai-icon">
                                        ...
                                        <span class="ms-2">Caixa de Entrada </span>
                                    </a>
                                    ...
                                    <a href="./notification.html" class="dropdown-item ai-icon ">
                                        ...
                                        <span class="ms-2">Notificação </span>
                                    </a>
                                    ...
                                    <a href="#" class="dropdown-item ai-icon ms-1" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18"
                                            height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<div class="dlabnav border-right">
    <div class="dlabnav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <ul aria-expanded="false">
                <li><a href="deliver-main.html">Painel</a></li>
                <li><a href="deliver-order.html">Tabela Pedidos</a></li>
                <li><a href="feedback.html">Histórico Pedidos</a></li>
            </ul>
