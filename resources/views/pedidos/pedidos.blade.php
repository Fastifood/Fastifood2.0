@auth
    ...
    @section('titulo-pagina', 'FastiFood - Pedidos')
...
@section('conteudo-principal')
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container">
                <div class="row">
                    {{-- <div class="sem-pedidos-text">
                        <h1>Ops, por enquanto não tem pedidos na sua loja!</h1>
                    </div> --}}
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                <nav class="order-tab">
                                    <div class=" nav nav-tabs" id="nav-tab" role="tablist">
                                        <button class="nav-link active" id="nav-order-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="nav-order" aria-selected="true">Novos</button>
                                        <button class="nav-link" id="nav-prepared-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-prepared" type="button" role="tab"
                                            aria-controls="nav-prepared" aria-selected="false">Preparo</button>
                                        <button class="nav-link" id="nav-delivered-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-delivered" type="button" role="tab"
                                            aria-controls="nav-delivered" aria-selected="false">Delivery</button>
                                    </div>
                                </nav>
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-order" role="tabpanel"
                                        ...
                                        @foreach($pedidos as $pedido)
                                            <div class="orderin-bx d-flex align-items-center justify-content-between">
                                                <div>
                                                    <h4>Pedido 1 #{{ $pedido->id }}</h4>
                                                    <span>{{ $pedido->created_at }}</span>
                                                </div>
                                                <div class="d-flex align-items-center">
                                                    <h4 class="text-primary mb-0">R${{ $pedido->valor_total }}</h4>
                                                    <a href="javascript:void(0);" class="icon-bx">
                                    ...
                                    <div class="tab-pane fade" id="nav-prepared" role="tabpanel"
                                        aria-labelledby="nav-prepared-tab">
                                        <div class="orderin-bx d-flex align-items-center justify-content-between">
                                            <div>
                                                <h4>Em preparo</h4>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <h4 class="text-primary mb-0">$202.00</h4>
                    ...
                    @foreach($pedidos as $pedido)
                        <div class="col-xl-8">
                            <div class="card border-0">
                                <h4 class="cate-title mb-sm-3 mb-2 mt-xl-0 mt-3">Detalhes do Pedido</h4>
                                <div class="card h-auto">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between border-bottom flex-wrap">
                                            <div class="mb-4">
                                                <h4 class="font-w500">Pedido #{{ $pedido->id }}</h4>
                                                <span>June 1, 2020, 08:22 AM</span>
                                            </div>
                                            <div class="orders-img d-flex mb-4">
                                                <img src="images/chat-img/orders-img/pic-1.jpg" alt="">
                                                <div>
                                                    <h6 class="font-w500">{{ $pedido->nome_cliente }}</h6>
                                                    <span>Usuario desde 2020</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row border-bottom pb-2">
                                            <div class="col-xl-6">
                                                <div class="address-bx mt-3">
                                                    <span class="d-block mb-2">Endereço do Pedido</span>
                                                    <div class="d-flex align-items-center mb-2">
                                                        <svg class="me-2" width="18" height="22" viewBox="0 0 18 22"
                                                        ...
                                                        <h4 class="mb-0 font-w700">{{ $pedido->endereco_cliente }}</h4>
                                            ...
                                            <div class="col-xl-4">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-3">
                                                    ...
                                                    <h6 class="mb-0">{{ $pedido->forma_pagamento }}</h6>
                                                </div>
                                            </div>
                                        ...
                                        <div class="order-menu style-1 mt-3">
                                            ...
                                            <div class="d-flex align-items-center mb-4">
                                                <img class="me-3" src="{{ asset('storage/acai.jpg') }}" alt="Produto">
                                                <div>
                                                    <h4 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Pizza
                                                            de Peperroni</a></h4>
                                                    <p class="mb-0">x1</p>
                                                </div>
                                                <h4 class="text-primary mb-0 ms-auto">+R$5.59</h4>
                                            </div>
                                            <div class="d-flex align-items-center mb-4">
                                                <img class="me-3" src="images/popular-img/review-img/pic-2.jpg"
                                                    alt="">
                                                <div>
                                                    <h4 class="font-w600 text-nowrap mb-0"><a
                                                            href="javascript:void(0);">Sushi</a></h4>
                                                    <p class="mb-0">x1</p>
                                                </div>
                                                <h4 class="text-primary mb-0 ms-auto">+R$5.59</h4>
                                            </div>
                                            <div class="d-flex align-items-center pb-2">
                                                ...
                                                <div>
                                                    <h4 class="font-w600 text-nowrap mb-0"><a
                                                            href="javascript:void(0);">Açai</a></h4>
                                                    <p class="mb-0">x1</p>
                                                </div>
                                                <h4 class="text-primary mb-0 ms-auto">+R$5.59</h4>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <h4 class="cate-title text-primary">R$12.59</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-end">
                                    <a href="javascript:void(0);" id="rejeitarPedidoBtn"
                                        class="btn btn-outline-danger me-sm-4 me-2">Rejeitar Pedido</a>
                                    <a href="javascript:void(0);" class="btn btn-primary">Aceitar Pedido <i
                                            class="fa-solid fa-hourglass accept-order-btn-icon"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <!-- Modal -->
                <div class="modal fade" id="rejeitarPedidoModal" tabindex="-1"
                    aria-labelledby="rejeitarPedidoModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="rejeitarPedidoModalLabel">Confirmar Rejeição</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                Você tem certeza que deseja rejeitar este pedido?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-cancelar" data-bs-dismiss="modal">Cancelar</button>
                                <button type="button" class="btn btn-danger" id="confirmarRejeicao">Rejeitar
                                    Pedido</button>
                            </div>
                        </div>
                    </div>
...
@section('outros-scripts')
    ...
    <script src="./js/scriptPagePedidos.js"></script>
