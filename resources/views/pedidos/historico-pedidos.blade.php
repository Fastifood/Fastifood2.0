@auth
    ...
    @section('titulo-pagina', 'FastiFood - Historico de Pedidos')
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                    <h4 class="cate-title">Historico de Pedidos</h4>
                                    <div class="d-flex align-items-center">
                                        <select class="form-control default-select  me-3 ms-0 mb-4 border"
                                            style="display: none;">
                                            <option>Região</option>
                                            <option>Corrégo do Jenipapo</option>
                                            <option>Nova Descoberta</option>
                                            <option>Alto do Eucalipito</option>
                                        </select>
                                        <select class="form-control default-select  ms-0 mb-4 border"
                                            style="display: none;">
                                        ...
                                        <div id="accordion-one" class="accordion style-1">
                                            <div class="accordion-item">
                                                <div class="accordion-header collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="dliver-order-bx d-flex align-items-center">
                                                        <img class="me-2" src="images/resturent-review/pic-1.jpg"
                                                            alt="">
                                                        <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex align-tems-center">
                                                            <svg class="me-2" width="24" height="25"
                                                    ...
                                                    <button
                                                        class="btn btn-outline-success bgl-success me-5">Completed</button>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-3 col-xxl-6 col-sm-6 b-right style-1">
                                                            <div class="order-menu my-4 dlab-space">
                                                                ...
                                                                <div
                                                                    class="d-flex align-items-center justify-content-xl-center justify-content-lg-start  mb-2">
                                                                    <img class="me-2"
                                                                        src="images/popular-img/review-img/pic-1.jpg"
                                                                        alt="">
                                                                    <div>
                                                                        <h6 class="font-w600 text-nowrap mb-0">Pepperoni
                                                                            Pizza</h6>
                                                                        <p class="mb-0">x1</p>
                                                                    </div>
                                                                ...
                                                                <div
                                                                    class="d-flex align-items-center justify-content-xl-center justify-content-lg-start">
                                                                    <img class="me-2" src="images/popular-img/pic-1.jpg"
                                                                        alt="">
                                                                    <div>
                                                                        <h6 class="font-w600 text-nowrap mb-0">Pepperoni
                                                                            Pizza</h6>
                                                            ...
                                                            <div class="dlab-space">
                                                                <div>
                                                                    ...
                                                                    <div class="d-flex align-items-center mb-4">
                                                                        ...
                                                                        <svg class="me-2" width="4" height="5"
                                                                            viewBox="0 0 4 5" fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <circle cx="2" cy="2.50003" r="2"
                                                                                fill="#C4C4C4" />
                                                                        </svg>
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="dliver-order-bx d-flex align-items-center">
                                                        <img class="me-2" src="images/deliver-order/pic-2.jpg"
                                                            alt="">
                                                        <div>
                                                    ...
                                                    <button
                                                        class="btn btn-outline-primary bgl-primary me-5 dev-btn">Delivering</button>
                                                    <span class="accordion-header-indicator"></span>
                                                </div>
                                                <div id="default_collapseOne2" class="collapse accordion_body"
                                                    data-bs-parent="#accordion-one">
                                                    <div class="row">
                                                        <div class="col-xl-3 col-xxl-6 col-sm-6 b-right style-1">
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="dliver-order-bx d-flex align-items-center">
                                                        <img class="me-2" src="images/deliver-order/pic-3.jpg"
                                                            alt="">
                                                        <div>
                                                ...
                                                <div id="default_collapseOne3" class="collapse accordion_body"
                                                    data-bs-parent="#accordion-one">
                                                    <div class="row">
                                                        <div class="col-xl-3  col-xxl-6 col-sm-6 b-right style-1">
                                                            <div class="order-menu my-4 dlab-space">
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="dliver-order-bx d-flex align-items-center">
                                                        <img class="me-2" src="images/deliver-order/pic-4.jpg"
                                                            alt="">
                                                        <div>
                                                    ...
                                                    <button
                                                        class="btn btn-outline-danger bgl-danger me-5">Canceled</button>
                                                    <span class="accordion-header-indicator"></span>
                                                </div>
                                                <div id="default_collapseOne4" class="collapse accordion_body"
                                                    data-bs-parent="#accordion-one">
                                                    <div class="row">
                                                        <div class="col-xl-3 col-xxl-6 col-sm-6 b-right style-1">
                                                            <div class="order-menu my-4 dlab-space">
                                                                <h4>Order Menu</h4>
                                                                <div
                                                                    class="d-flex align-items-center justify-content-xl-center justify-content-lg-start  mb-2  border-xl-right border-0">
                                                                    <img class="me-2"
                                                                        src="images/popular-img/review-img/pic-1.jpg"
                                                                        alt="">
                                                                    <div>
