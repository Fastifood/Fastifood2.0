@auth
    ...
    @section('titulo-pagina', 'FastiFood - Home')
              ...
              <img src="images/banner-img/pic-1.jpg" alt="">
                            ...
                            <div class="col-xl-12">
                                <div class="d-flex align-items-center justify-content-between mb-2 gap">
                                    <h4 class=" mb-0 cate-title">Categorias</h4>
                                    <a href="favorite-menu.html" class="text-primary">View all <i
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <svg width="50" height="50" viewBox="0 0 50 50"
                                                            ...
                                                            <path d="M33.5417 33.0729H16.6146V44.6354H33.5417V33.0729Z"
                                                                fill="#A6C44A" />
                                                            <path
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#3D4152" />
                                                            <path d="M21.0416 35.2083H19.0104V42.0312H21.0416V35.2083Z"
                                                                fill="#3D4152" />
                                                            <path d="M26.0937 35.2083H24.0625V42.0312H26.0937V35.2083Z"
                                                                fill="#3D4152" />
                                                            <path d="M31.0938 35.2083H29.0625V42.0312H31.0938V35.2083Z"
                                                                fill="#3D4152" />
                                                            <path
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <h6 class="mb-0 font-w500">Bakery</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="cate-bx text-center">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <h6 class="mb-0 font-w500">Burger</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <svg width="50" height="50" viewBox="0 0 50 50"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#3D4152" />
                                                            <path d="M15 48.6979H35L36.25 38.8542H13.75L15 48.6979Z"
                                                                fill="white" />
                                                            <path
                                                        ...
                                                        <a href="javscript:void(0);">
                                                            <h6 class="mb-0 font-w500">Beverage</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <svg width="50" height="50" viewBox="0 0 50 50"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#3D4152" />
                                                            <path d="M13.9583 0.78125H11.875V7.23958H13.9583V0.78125Z"
                                                                fill="#3D4152" />
                                                            <path d="M7.81246 9.79166H5.72913V16.25H7.81246V9.79166Z"
                                                                fill="#3D4152" />
                                                            <path d="M20.1563 7.76041H18.073V14.2187H20.1563V7.76041Z"
                                                                fill="#3D4152" />
                                                        </svg>
                                                        <a href="javascript:void(0);">
                                                            <h6 class="mb-0 font-w500">Chicken</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="cate-bx text-center">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <h6 class="mb-0 font-w500">Pizza</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-xl-12">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <h4 class=" mb-0 cate-title">Popular</h4>
                                    <a href="favorite-menu.html" class="text-primary">Ver todos<i
                                            class="fa-solid fa-angle-right ms-2"></i></a>
                                </div>
                                    ...
                                    <div class="swiper-wrapper">
                                                ...
                                                <div class="card-footer border-0 px-3">
                                                    ...
                                                    <div class="common d-flex align-items-end justify-content-between">
                                                        <div>
                                                            ...
                                                            <h3 class="font-w700 mb-0 text-primary">R$5.59</h3>
                                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card dishe-bx exclusive">
                                                <div class="card-header border-0 pb-0 pt-0 pe-3">
                                                    <span class="badge badge-lg badge-warning side-badge">Exclusivo</span>
                                                    <i class="fa-solid fa-heart ms-auto c-heart c-pointer"></i>
                                                </div>
                                                <div class="card-body p-0 text-center">
                            ...
                            <div class="col-xl-12">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <h4 class=" mb-0 cate-title">Pedido Recentes</h4>
                                    <a href="favorite-menu.html" class="text-primary">Ver todos <i
                                            class="fa-solid fa-angle-right ms-2"></i></a>
                                </div>
                                <div class="swiper mySwiper-3">
                                                ...
                                                <div class="card dishe-bx b-hover review style-1">
                                                    ...
                                                    <div class="card-footer pt-0 border-0 text-center">
                                                        <div>
                                                            ...
                                                            <h3 class="font-w700 text-primary">R$5.59</h3>
                            ...
                            <div class="col-xl-12">
                                <div class="card dlab-bg dlab-position">
                                    ...
                                    <div class="card-body pt-0 pb-2">
                                        ...
                                        <div class="bb-border">
                                            <p class="font-w500 text-primary fs-15 mb-2">Seu Endereço</p>
                                            <div class="d-flex  align-items-center justify-content-between mb-2">
                                                <h4 class="mb-0">
                                                    ...
                                                    Erundina Negreiros, 41
                                                </h4>
                                                <a href="javascript:void(0);"
                                                    class="btn btn-outline-primary btn-sm change">Alterar</a>
                                            </div>
                                            ...
                                            <div class="d-flex">
                                                            ...
                                                            <div class="modal-body add-loaction">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <select
                                                                            class="form-control default-select ms-0 py-4 wide"
                                                                            style="display: none;">
                                                                            <option>Home</option>
                                                ...
                                                <div class="modal fade" id="exampleModal2" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel2">Manage
                                                                    Route Notes</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body add-note">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-xl-12">
                                                                        <form class=" mb-3">
                                                                            <label class="form-label">Drop Off
                                                                                Location</label>
                                                                            <input type="Text" class="form-control"
                                        ...
                                        <div class="order-check d-flex align-items-center my-3">
                                            ...
                                            <div class="dlab-info">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h4 class="dlab-title"><a href="javascript:void(0);">Pepperoni
                                                            Pizza</a></h4>
                                                    <h4 class="text-primary ms-2">+R$5.59</h4>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <span>x1</span>
                                                    <div class="quntity">
                                        ...
                                        <div class="order-check d-flex align-items-center my-3">
                                            ...
                                            <div class="dlab-info">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h4 class="dlab-title"><a href="javascript:void(0);">Japan Ramen</a>
                                                    </h4>
                                                    <h4 class="text-primary ms-2">+R$5.59</h4>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="order-check d-flex align-items-center my-3">
                                            ...
                                            <div class="dlab-info">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h4 class="dlab-title"><a href="javascript:void(0);">Fried Rice</a>
                                                    </h4>
                                                    <h4 class="text-primary ms-2">+R$5.59</h4>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="card-footer  pt-0 border-0">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <p>Serviço</p>
                                            <h4 class="font-w500">+R$1.00</h4>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <h4 class="font-w500">Total</h4>
                                            <h3 class="font-w500 text-primary">R$202.00</h3>
                                        </div>
                                        <a href="checkout-page.html" class="btn btn-primary btn-block">Conferir Pedido</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-12">
